...
\section{Profile}
\small{
  INSERT TEXT HERE! \textbf{3 years of experience} in building robust data models. 
}
%--------------------------------------------
...
\section{Technical Skills}
  \resumeHeadingListStart{}
    \resumeSectionType{Thing 1}{:}{Stuff!}
    \resumeSectionType{Thing 2}{:}{More Stuff!}
    \resumeSectionType{Thing 3}{:}{More Stuff!}
    \resumeSectionType{Databases}{:}{MySQL, BigQuery, Iceberg/AWS Athena}
    \resumeSectionType{Dev Tools}{:}{Visual Studio Code, Git, AI Workflows}
...
\resumeHeadingListStart{}
  ...
  \resumeQuadHeading{Business Data Analyst}{Aug 2021 -- Nov 2022}
